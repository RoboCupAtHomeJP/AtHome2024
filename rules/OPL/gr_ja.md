...
1. **メイヤー変更**: 日常の環境で完全に静止することが期待できない家具（事前に定義された場所にあるかどうかに関係なく）は、テスト間でわずかに移動する場合がある。
特に、家具は部屋を変更したり、部屋の中で大幅に移動したりすることはありませんが、ソファやテーブルはわずかに回転したり移動したりすることがある。
このような家具の固定位置は想定しないでください。
壁はそのままであり、部屋のレイアウトは変わらない。
通路はブロックされる場合がる。

1. **マイナー変更**: わずかに移動した椅子、わずかに閉じたドアなど、同様にいつでも起こり得る。
...
1. **Technical Challenge**: *Technical Challenge*では、両方のロボットを同時に使用することができる。
...
- チーム $` (a+n) mod. n `$ から*1人*のスコアリングメンバー
- チーム $` (1+a+n) mod. n `$ から*1人*のスコアリングメンバー
...
- 最初のタスク：
  - *チーム1*が競技：*チーム1*と*チーム2*からのメンバー（*2人*のスコアリングメンバー）
  - *チーム2*が競技：*チーム2*と*チーム3*からのメンバー（*2人*のスコアリングメンバー）
  - *チーム3*が競技：*チーム3*と*チーム1*からのメンバー（*2人*のスコアリングメンバー）
- 2番目のタスク：
  - *チーム2*が競技：*チーム2*と*チーム3*からのメンバー（*2人*のスコアリングメンバー）
  - *チーム3*が競技：*チーム3*と*チーム1*からのメンバー（*2人*のスコアリングメンバー）
  - *チーム1*が競技：*チーム1*と*チーム2*からのメンバー（*2人*のスコアリングメンバー）
- 3番目のタスク：
  - *チーム3*が競技：*チーム3*と*チーム3*からのメンバー（*2人*のスコアリングメンバー）
  - *チーム1*が競技：*チーム1*と*チーム1*からのメンバー（*2人*のスコアリングメンバー）
  - *チーム2*が競技：*チーム2*と*チーム2*からのメンバー（*2人*のスコアリングメンバー）
- 以降も同様に続く
